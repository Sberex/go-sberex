...
// Package chequebook package wraps the 'chequebook' Sberex smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in sbr; (auto)cashing cheques in sbr
// as well as (auto)depositing sbr to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/Sberex/go-sberex/contracts/chequebook/contract"
	"github.com/Sberex/go-sberex/core/types"
	"github.com/Sberex/go-sberex/crypto"
	"github.com/Sberex/go-sberex/log"
	"github.com/Sberex/go-sberex/swarm/services/swap/swap"
)
...
// * depositing sbr to the chequebook
// * watching incoming sbr
...
// Cash cashes the cheque by sending an Sberex transaction.
