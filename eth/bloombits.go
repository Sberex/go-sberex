...
const (
	// bloomServiceThreads is the number of goroutines used globally by an Sberex
...
func (eth *Sberex) startBloomHandlers() {
...
// for the Sberex header bloom filters, permitting blazing fast filtering.
