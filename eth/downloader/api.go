...
// Syncing provides information when this nodes starts synchronising with the Sberex network and when it's finished.
...
type SyncingResult struct {
	...
	Status  sberex.SyncProgress `json:"status"`
}
