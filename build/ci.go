...
import (
	...
	"github.com/Sberex/go-sberex/internal/build"
)
...
var (
	...
	debExecutables = []debExecutable{
		{
			Name:        "abigen",
			Description: "Source code generator to convert Sberex contract definitions into easy to use, compile-time type-safe Go packages.",
		},
		{
			Name:        "bootnode",
			Description: "Sberex bootnode.",
		},
		{
			Name:        "evm",
		...
		{
			Name:        "geth",
			Description: "Sberex CLI client.",
		},
		{
			Name:        "puppeth",
			Description: "Sberex private network manager.",
		},
		{
			Name:        "rlpdump",
		...
		{
			Name:        "swarm",
			Description: "Sberex Swarm daemon and tools",
		},
		{
			Name:        "wnode",
			Description: "Sberex Whisper diagnostic tool",
		},
	}
...
func doInstall(cmdline []string) {
	...
	if !strings.Contains(runtime.Version(), "devel") {
		...
		if minor < 7 {
			...
			log.Println("go-sberex requires at least Go version 1.7 and cannot")
...
func doDebianSource(cmdline []string) {
	var (
		...
		upload  = flag.String("upload", "", `Where to upload the source package (usually "ppa:sberex/sberex")`)
...
type debMetadata struct {
	...
	// go-sberex version being built. Note that this
...
func newDebMetadata(distro, author string, env build.Environment, t time.Time) debMetadata {
	if author == "" {
		...
		author = "Sberex Builds <gosberex@gmail.com>"
	}
	return debMetadata{
		Env:         env,
		Author:      author,
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.sberex", "-v", "github.com/Sberex/go-sberex/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/Sberex/go-sberex/mobile")
