...
const (
	...
	EpochDuration    uint64 = 90000 // Duration between proof-of-work epochs.
	...
	MaxCodeSize = 73728 // Maximum bytecode to permit for a contract
...
var (
	...
	DurationLimit          = big.NewInt(33)     // The decision boundary on the blocktime duration used to determine whether difficulty should go up or not.
)
