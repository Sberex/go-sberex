...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Sberex presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    geth wallet import /path/to/my/presale.wallet

will prompt for your password and imports your sbr presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Sberex presale wallet",
				ArgsUsage: "<keyFile>",
...
between sberex nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another sberex instance,
