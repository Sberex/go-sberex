...
type wizard struct {
	...
	services map[string][]string   // Sberex services known to be running on servers
...
// converts it to an Sberex address. If an empty line is entered, the default
// value is returned.
