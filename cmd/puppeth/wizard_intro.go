...
// setting up a new or managing an existing Sberex private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Sberex private network manager   |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Sberex network down to    |")
	...
	log.Info("Administering Sberex network", "name", w.network)
