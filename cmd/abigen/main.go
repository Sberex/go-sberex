...
import (
	...
	"github.com/Sberex/go-sberex/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Sberex contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Sberex contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Sberex contract Solidity source to build and bind")
