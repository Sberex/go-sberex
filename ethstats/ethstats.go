...
// Service implements an Sberex netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Sberex        // Full Sberex service if monitoring a full node
	les    *les.LightSberex   // Light Sberex service if monitoring a light node
...
func New(url string, ethServ *eth.Sberex, lesServ *les.LightSberex) (*Service, error) {
