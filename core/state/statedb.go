...
// Package state provides a caching layer atop the Sberex state trie.
package state
...
// StateDBs within the sberex protocol are used to store anything
...
//
// Carrying over the balance ensures that Sbr doesn't disappear.
