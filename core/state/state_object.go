...
// stateObject represents an Sberex account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of sberex address of the account
	data     Account
	db       *StateDB
...
// Account is the Sberex consensus representation of accounts.
