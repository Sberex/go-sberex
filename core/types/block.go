...
// Package types contains data types related to Sberex consensus.
package types
...
// Header represents a block header in the Sberex blockchain.
type Header struct {
...
// Block represents an entire block in the Sberex blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Sberex RLP block format.
