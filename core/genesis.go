...
// GenesisBlockForTesting creates and writes a block in which addr has the given leto balance.
func GenesisBlockForTesting(db ethdb.Database, addr common.Address, balance *big.Int) *types.Block {
	g := Genesis{Alloc: GenesisAlloc{addr: {Balance: balance}}}
	return g.MustCommit(db)
}

// DefaultGenesisBlock returns the Sberex main net genesis block.
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.MainnetChainConfig,
		Nonce:      0,
		ExtraData:  hexutil.MustDecode("0x5362657265782050726f6a656374206174207777772e7362657265782e6f7267"),
		GasLimit:   2100000,
